...
interface MainSlideSectionProps {
  slides: SlideData[]
...
const MainSlideSection: React.FC<MainSlideSectionProps> = ({
  slides,
  onSlideToggle,
  onSlideMoveUp,
  onSlideMoveDown,
  ...
  return (
    <div className="content-section slide-management-section">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h2 style={{ margin: 0, fontSize: '18px' }}>📺 메인슬라이드 관리</h2>
        <button 
                  ...
                  <label className="toggle-switch">
                    <input
                      ...
                      onChange={(e) => {
                        e.preventDefault()
                        e.stopPropagation()
                        onSlideToggle(slide.id, !slide.isActive, 'main')
                      }}
                    />
